...
Target_list = {"https://www.youtube.com/user/tarmax82/videos": "asmr卤蛋哥",
               ...
               "https://www.youtube.com/channel/UCyehQnSh2DGldGpFCA1PWLw/videos": "骚叔",
               "https://www.youtube.com/channel/UCz3IQwvc4t5A_afmS4wqqhg/videos": "美甲",
               "https://www.youtube.com/user/laws507/videos": "野外求生Primitive Life",
               "https://www.youtube.com/channel/UCAL3JXZSzSm8AlZyD3nQdBA/videos": "澳洲小哥",
               "https://www.youtube.com/channel/UC1rL83kf1ICDj7eBpGi6m5Q/videos": "野外求生Survival Instinct",
               "https://www.youtube.com/channel/UChUP6B_3zcdFYZnOdMM21og/videos": "野外求生两兄弟"}
...
class YoutubeDL(object):
    ...
    def check_txt(self):  # 查有无txt，无则新建下载列表。有则执行check_video_list
        if x == "https://www.youtube.com/channel/UCJ7YhtO8_nGqk1_aJHzo6Jg/videos":
            global COMMAND_PREFIX_DOWNLOAD
        ...
        if os.path.exists(self.Txt_path):
            ...
            self.get_video_list()
            self.save_txt()
            for url in self.url_ilst[:15]:
                t = threading.Thread(target=self.download_by_url, args=(url,))
                t.start()
...
if __name__ == '__main__':
    for x in Target_list.keys():
        t = YoutubeDL(x)
        thread_t = threading.Thread(target=t.main)
        thread_t.start()
